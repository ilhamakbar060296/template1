...
<body>
  <center><h2> Re-Upload Kinerja Pengabdian </h2></center>  
  <div class="container" style="margin-top: 80px">
    <div class="col-mid-12">
      <?php echo form_open_multipart('peserta/update_pengabdian');?>               
      ...
      <form>
        <tbody>          
          ...
          <tr>
            ...
            <td><input type="text" name="PENGABDIAN" value="<?php echo $hasil->no_berkas ?>" class="form_control" placeholder="Masukkan No Pengabdian">
          </tr>
          <tr>
            <td><label for="text">NAMA PENGABDIAN</label></td>
            <td><input type="text" name="KEGIATAN" value="<?php echo $hasil->kegiatan ?>" class="form_control" placeholder="Masukkan Nama Pengabdian">
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="TEMPAT" value="<?php echo $hasil->tempat_berkas ?>" class="form_control" placeholder="Lokasi Pengabdian ">
          </tr>
          <tr>
