...
<body>
  <center><h2> Upload Kinerja Bidang Pendidikan </h2></center>  
  <div class="container" style="margin-top: 80px">
    <div class="col-mid-12">
      <?php echo form_open_multipart('peserta/simpan_pendidikan');?>               
      ...
      <form>
        <tbody>          
          ...
          <tr>
            ...
            <td><input type="text" name="IJAZAH" class="form_control" placeholder="Masukkan No Ijazah">
          </tr>
          <tr>
            <td><label for="text">TINGKAT IJAZAH</label></td>
            <td><input type="text" name="S" class="form_control" placeholder="Masukkan S1, S2, S3">
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="TEMPAT" class="form_control" placeholder="Lulus dari Universitas ">
          </tr>
          <tr>
            <td><label for="text">FAKULTAS</label></td>
            <td><input type="text" name="FAKUL" class="form_control" placeholder="Lulus dari Fakultas ">
          </tr>
          <tr>
