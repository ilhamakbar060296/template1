  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">         
          ...
          ?>
          <p class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $hasil->nama_peserta ?></p>
          <?php } ?>  <br>
          <!--<span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $profile ?></span>-->
          <!--<h1>ID : <?php echo $hasil->id?></h1>-->
        <p class="mr-2 d-none d-lg-inline text-gray-600 small">NO PESERTA : <?php echo $hasil->no_peserta?></p>
