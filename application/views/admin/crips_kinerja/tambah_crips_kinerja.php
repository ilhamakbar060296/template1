...
<body>
	<center><h2> Tambah Crips Kinerja </h2></center>	
	<div class="container" style="margin-top: 80px">
		<div class="col-mid-12">
			<?php echo form_open('admin/simpan_crips_kinerja');?>											
			<table id="table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					<tr>
						...
						echo "<option value='$hasil->no'>$hasil->nama_kinerja</option>";
						}
						?>
						</select></td>
						</div>
					...
					<tr>
						...
						<td><input type="text" name="CRIPS" class="form_control" placeholder="Masukkan penilaian"></td>
						</div>												
					</tr>
					<tr>
					<div class="form-group">
